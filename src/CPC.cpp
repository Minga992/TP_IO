...
//cant_aris   : cantidad de aristas del grafo V
...
// Genero el problema de cplex.
  ...
  //LOS LIMITES cant_vert*cant_vert + cant_vert porque x_ij en nuestro PLEM i se acota por la cant de vert 
  ...
  ub = new double[cant_vert*cant_vert + cant_vert]; 
  lb = new double[cant_vert*cant_vert + cant_vert];
  objfun = new double[cant_vert*cant_vert + cant_vert];
  xctype = new char[cant_vert*cant_vert + cant_vert];
  colnames = new char*[cant_vert*cant_vert + cant_vert];  //no estoy seguro de que le podamos poner nombre a esto
  
  for (int i = 0; i < (cant_vert*cant_vert + cant_vert); i++) {
    ...
    colnames[i] = new char[10];   //no se si se le pueded poner nombre, lo dejo, pero comento su codigo
  }

/* ------------------NO SE SI LE VAMOS A PODER PONER LOS NOMBRES A LAS VARIABLES TRANQUILOS-----------
